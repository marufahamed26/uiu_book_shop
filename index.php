...
if (isset($_POST['search'])) {
    ...
    $result = "SELECT post_id,user_id,book_title,orginal_price,your_price,cover FROM user_post Order By post_id DESC LIMIT 0,4 ";
...
<!-- new -->
	<div class="newproducts-w3agile">
		<div class="container">
			<h3><a href="sell_post.php">New offers</a></h3>
									...
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="products.html"><img title=" " alt=" " src="cover/3.png"></a>		
