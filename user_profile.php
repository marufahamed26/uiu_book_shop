...
$result = "SELECT * FROM user_post WHERE user_id ='".$user_id."'  ";
$search_result = filterTable($result);

if(isset($_GET['selected_id'])){
    echo "deleted";
	$post_id= $_GET['selected_id'];
			...
			<div class="grid_3 grid_5">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<ul id="myTab" class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#expeditions" id="expeditions-tab" role="tab" data-toggle="tab" aria-controls="expeditions" aria-expanded="true">User post</a></li>
					</ul>
...
//							echo								"<p >Stress Proof your Life</p>";
                                                        echo    "<li><a href='post_details.php?post_id=".$row['post_id']."'>".$b_title."</a></li>";
							...
							echo								"<form action='#' method='get'>";?>
																	...
																	<a href="update_post.php?post_id=<?php echo urlencode($row['post_id']); ?>" class='all-post'>Edit</a>
                                                                                                                            <?php     echo "       <br><br>
                                                                                                                                        <a href='user_profile.php?selected_id=".$row['post_id']. "' class='all-post'>Delete</a>
